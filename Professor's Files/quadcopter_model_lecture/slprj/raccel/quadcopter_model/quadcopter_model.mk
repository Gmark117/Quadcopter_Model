...
MODULES                 = rt_logging.c quadcopter_model.c quadcopter_model_capi.c quadcopter_model_data.c quadcopter_model_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = quadcopter_model
MAKEFILE                = quadcopter_model.mk
MATLAB_ROOT             = /Applications/MATLAB_R2020b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2020b.app
START_DIR               = /Users/kekko/Documents/Didattica/Corsi/Corso-Design\ methods\ for\ unmanned\ vehicles/quadcopter_model_lecture
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 12
COMPUTER                = MACI64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/quadcopter_model \
