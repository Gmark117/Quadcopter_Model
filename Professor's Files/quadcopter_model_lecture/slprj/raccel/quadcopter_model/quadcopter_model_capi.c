...
} , { 1 , 2 , TARGET_STRING ( "quadcopter_model/quadcop_eqns" ) ,
TARGET_STRING ( "" ) , 0 , 0 , 1 , 0 , 0 } , { 2 , 2 , TARGET_STRING (
"quadcopter_model/quadcop_eqns" ) , TARGET_STRING ( "" ) , 1 , 0 , 2 , 0 , 0
...
4 , 0 } , { 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 } } ; static const
rtwCAPI_Signals rtRootInputs [ ] = { { 0 , 0 , ( NULL ) , ( NULL ) , 0 , 0 ,
0 , 0 , 0 } } ; static const rtwCAPI_Signals rtRootOutputs [ ] = { { 0 , 0 ,
( NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 } } ; static const
rtwCAPI_ModelParameters rtModelParameters [ ] = { { 8 , TARGET_STRING ( "K_z"
) , 0 , 3 , 0 } , { 9 , TARGET_STRING ( "h_des" ) , 0 , 3 , 0 } , { 10 ,
TARGET_STRING ( "quad_data" ) , 0 , 5 , 0 } , { 11 , TARGET_STRING (
"y_init_conds" ) , 0 , 5 , 0 } , { 0 , ( NULL ) , 0 , 0 , 0 } } ;
#ifndef HOST_CAPI_BUILD
static void * rtDataAddrMap [ ] = { & rtB . pi4eofv0sv [ 0 ] , & rtB .
opmcsbpyyp [ 0 ] , & rtB . dmjl1m4evq [ 0 ] , & rtB . gd2vivdw2i , & rtB .
cnvn12114y [ 0 ] , & rtB . kxute4dok2 [ 0 ] , & rtB . cl2xjd5eqd , & rtP .
...
, { 1331684444U , 1905909690U , 1892146517U , 387458579U } , ( NULL ) , 0 , 0
